...
function applyWeatherData(forecastData) {
  ...
  document.querySelector(".temperature-feels-like.tomorrow").textContent =
    Math.round(tomorrowFeelsLike);
  document.querySelector(".temperature-degree.day-after-tomorrow").textContent =
    Math.round(datTemp);
  document.querySelector(".temperature-feels-like.day-after-tomorrow").textContent =
    Math.round(datFeelsLike);
