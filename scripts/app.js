window.addEventListener("load", () => {
  ...
  let titleLocation = document.querySelector(".title-location")

  const _apiBaseEn = "https://api.openweathermap.org/data/2.5/onecall?lang=en"
  const _apiBaseRu = "https://api.openweathermap.org/data/2.5/onecall?lang=ru"
  const _apiBaseUa = "https://api.openweathermap.org/data/2.5/onecall?lang=ua"
  const _apiBaseEsp = "https://api.openweathermap.org/data/2.5/onecall?lang=es"
  let _apiBase = "https://api.openweathermap.org/data/2.5/onecall?"

  let LangEn = document.querySelector("#lang-switcher-en")
  let LangRu = document.querySelector("#lang-switcher-ru")
  let LangUa = document.querySelector("#lang-switcher-ua")
  let LangEs = document.querySelector("#lang-switcher-es")
  ...
  navigator.geolocation
    ? navigator.geolocation.getCurrentPosition((position) => {
        ...
        const apiForecast = `${_apiBase}&lat=${lat}&lon=${long}&units=metric&appid=422966cfe87d86a464cecdd3bfde88d7`
        ...
        fetch(api)
          ...
          .then((data) => {
            ...
            location1.textContent = location2.textContent = location3.textContent = titleLocation.textContent =
              data.name
          })
...
let weatherTitleToday = document.querySelector("#weather-title-today")
let weatherTitleTomorrow = document.querySelector("#weather-title-tomorrow")
let weatherTitleDAT = document.querySelector(
  "#weather-title-day-after-tomorrow"
)
let weatherToday = document.querySelector("#weather-today")
let weatherTomorrow = document.querySelector("#weather-tomorrow")
let weatherDAT = document.querySelector("#weather-day-after-tomorrow")

weatherTitleToday.addEventListener("click", () => {
  weatherTitleToday &&
    ((weatherToday.style.display = "none"),
    (weatherTomorrow.style.display = "grid"),
    (weatherDAT.style.display = "none"))
})

weatherTitleTomorrow.addEventListener("click", () => {
  weatherTitleTomorrow &&
    ((weatherToday.style.display = "none"),
    (weatherTomorrow.style.display = "none"),
    (weatherDAT.style.display = "grid"))
})

weatherTitleDAT.addEventListener("click", () => {
  weatherTitleDAT &&
    ((weatherToday.style.display = "grid"),
    (weatherTomorrow.style.display = "none"),
    (weatherDAT.style.display = "none"))
})

console.log(weatherTitleToday)
